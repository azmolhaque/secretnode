...
![Version](https://img.shields.io/badge/version-2.14.5-blue)
...
> **v2.14.5 — the leak pattern that dominates real bundles, and a corpus that can measure precision** ·
...
│   ├── scanner.py           # Async scan engine (72 patterns, source maps, entropy, base64, Gemini, Discord)
